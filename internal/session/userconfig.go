...
import (
	...
	"github.com/potato-hash/groundskeeper/internal/atomicfile"
	"github.com/potato-hash/groundskeeper/internal/logging"
	"github.com/potato-hash/groundskeeper/internal/platform"
	"github.com/potato-hash/groundskeeper/internal/safeio"
...
func SaveUserConfigWithIntent(config *UserConfig, allowSectionDrop bool) error {
	...
	if _, err := buf.WriteString("# All options: https://github.com/potato-hash/groundskeeper/blob/main/skills/agent-deck/references/config-reference.md\n\n"); err != nil {
		return fmt.Errorf("failed to write header: %w", err)
	}
